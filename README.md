...
expose source paths, generated-brief paths, or source row values; the same sanitized
summaries are used by `/health.json`. Detail rendering is capped at 200 columns and
